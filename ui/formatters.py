...
COLUMN_LABELS_ES = {
    ...
    "market_opportunity_status": "Estado de oportunidad",
    "technical_opportunity_score": "Oportunidad técnica",
    "decision_lane": "Libro institucional",
    "decision_reasons": "Razones del libro",
    "rr_stressed": "R/R estresado",
    "risk_geometry_status": "Geometría de riesgo",
    "risk_geometry_reason": "Razón geometría",
    "earnings_event_status": "Estado earnings",
    "earnings_data_confidence": "Confianza earnings",
    "earnings_refresh_required": "Actualizar earnings",
    "earnings_review_reason": "Riesgo earnings",
    "sector_relative_strength_score": "Fuerza vs. sector",
    "sector_relative_leadership_status": "Liderazgo sectorial",
    "technical_asset_quality_score": "Calidad técnica",
    "entry_readiness_score": "Readiness entrada",
    "research_priority_score": "Prioridad investigación",
    "reset_watch_score": "Prioridad de reset",
    "context_confidence_score": "Confianza contexto",
    "data_confidence_score": "Confianza datos",
    "technical_analysis_lane": "Carril de análisis",
    "deep_analysis_tier": "Nivel de análisis",
    "operational_eligibility": "Elegibilidad operativa",
    "research_eligibility_reason": "Razón de investigación",
    "setup_readiness_score": "Madurez setup",
    "setup_readiness_state": "Estado setup",
    "setup_candidate_type": "Setup candidato",
    "primary_setup_hypothesis": "Tesis principal",
    "primary_setup_hypothesis_state": "Estado tesis principal",
    "primary_setup_hypothesis_score": "Score tesis principal",
    "alternative_setup_hypotheses": "Tesis alternativas",
    "setup_hypothesis_count": "Cantidad de tesis",
    "technical_eligibility_reason": "Razón de elegibilidad",
    "trend_setup_compatibility": "Compatibilidad tendencia/setup",
    "trend_setup_compatibility_reason": "Razón tendencia/setup",
    "research_trend_compatibility": "Compatibilidad para investigación",
    "research_trend_compatibility_reason": "Razón tendencia investigación",
    "momentum_gate_status": "Gate momentum",
    "timing_gate_status": "Gate timing",
    "core_liquidity_status": "Liquidez estructural",
    "execution_spread_status": "Estado spread",
    "daily_macd_operable": "MACD diario operable",
    "weekly_macd_operable": "MACD semanal operable",
    "technical_prefilter_status": "Prefiltro técnico",
    "technical_prefilter_triage": "Triage técnico",
    ...
    "rr_status": "Estado R/R",
    "rr_confidence": "Confianza R/R",
    "target_validation_source": "Fuente validación target",
    "target_validation_sources": "Confluencia target",
    "entry_zone_low": "Zona entrada mínima",
    "entry_zone_high": "Zona entrada máxima",
    "technical_as_of_date": "Cierre técnico",
    "technical_bar_policy": "Política de velas",
    "daily_bar_complete": "Vela diaria cerrada",
    "weekly_bar_complete": "Semana cerrada",
    "intraday_bar_excluded": "Vela intradía excluida",
    ...
    "daily_macd_trajectory_state": "Trayectoria MACD diaria",
    "daily_macd_trajectory_confidence": "Confianza MACD diaria",
    "daily_macd_hist_slope": "Pendiente MACD diaria",
    "daily_macd_hist_acceleration": "Aceleración MACD diaria",
    "daily_macd_non_decelerating": "MACD diario no desacelera",
    "weekly_macd_trajectory_state": "Trayectoria MACD semanal",
    "weekly_macd_trajectory_confidence": "Confianza MACD semanal",
    "weekly_macd_hist_slope": "Pendiente MACD semanal",
    "weekly_macd_hist_acceleration": "Aceleración MACD semanal",
    "weekly_macd_non_decelerating": "MACD semanal no desacelera",
    "momentum_alignment": "Sincronía de momentum",
    "momentum_alignment_confidence": "Confianza de sincronía",
    "momentum_operability_status": "Condición de momentum",
    "operational_status": "Estado operativo",
    "sector_leadership_override_status": "Liderazgo frente al sector",
    "sector_headwind_strength": "Presión sectorial",
    "ema20_extension_risk": "Riesgo extensión EMA20",
    "ema20_extension_confidence": "Confianza extensión EMA20",
    "ema20_extension_driver": "Causa extensión EMA20",
    "ema20_distance_percentile_1y": "Percentil distancia EMA20",
    "ema20_extension_model": "Modelo extensión",
    "trend_transition_score": "Score transición tendencia",
    "trend_transition_state": "Estado transición tendencia",
    "trend_transition_reason": "Razón transición tendencia",
    ...
    "required_confirmations": "Confirmaciones requeridas",
    "invalidation_conditions": "Condiciones de invalidación",
