...
object CanonicalEngineConfiguration {
    ...
    fun create(
        ...
        "fundamentalProviderPrimary" to "SEC_COMPANYFACTS_POINT_IN_TIME_BACKEND",
        "fundamentalProviderFallbackOrder" to "YAHOO_RESEARCH_ONLY",
        "optionsProviderPrimary" to "ALPACA_OPRA_BACKEND",
        "optionsProviderFallback" to "YAHOO_RESEARCH_ONLY",
        "macroProviderPrimary" to "FRED_ALFRED_POINT_IN_TIME",
        "calendarProvider" to "LOCAL_VERSIONED_NYSE",

        // Canonical technical indicators and warm-up
        "minimumHistoryBars" to "220",
        "discoveryRsi14Minimum" to canonical(25.0),
        "discoveryRsi14Maximum" to canonical(65.0),
        "discoveryRequiresRsi6AboveRsi14" to "true",
        "discoveryPreRankingMaximumSymbols" to "NONE",
        "smaFastPeriod" to "20",
        "smaSlowPeriod" to "50",
        "emaFastPeriod" to "20",
        ...
        "fundamentalEarningsRiskMode" to "ADVISORY_ONLY",
        ...
        "institutionalContextRole" to "ADVISORY_ONLY_NEVER_FILTERS_OR_PENALIZES",
        "unknownInstitutionalCoveragePolicy" to "VISIBLE_WARNING_NO_SELECTION_EFFECT",
        ...
        "walkForwardMode" to "ROLLING_EXPANDING",
        "walkForwardTrainingMinimumObservations" to "120",
        "walkForwardValidationObservations" to "40",
        "walkForwardTestObservations" to "40",
        "walkForwardStepObservations" to "40",
        "walkForwardEmbargoSessions" to "21",
        "walkForwardMinimumOutOfSampleClosed" to "200",
        "walkForwardMinimumDominantSetupClosed" to "40",
        "walkForwardBootstrapConfidencePct" to canonical(95.0),
        "walkForwardMinimumDistinctRegimes" to "2",
        "walkForwardVersion" to RollingWalkForwardEngine.VERSION,
